...
# 2. Restart the DGD workers to drop KV / prefix-cache state
kubectl rollout restart deployment -n ${NAMESPACE} \
  -l nvidia.com/dynamo-graph-deployment-name=turbo-kimi-k26-agg-b200-chat
kubectl rollout status deployment -n ${NAMESPACE} \
  -l nvidia.com/dynamo-graph-deployment-name=turbo-kimi-k26-agg-b200-chat --timeout=900s
